...
void scene_structure::initialize()
{
	...
	environment.camera.look_at({ 0.0f,2.0f,150.0f }, { 0,0,0 });
	...
	mouvement = {0,0, timer.t_min+0.1f,0,0,0};
...
*/
	...
	mouvementWagon2 = piston1.updateWagon2(mouvement[1],0.04f, mont.terrain_mesh, p, chemin1,mouvement[5]-7.0f,timer.t_min, timer.t_max, mouvementWagon2[0],mouvementWagon2[1], tabConversion);
	...
	displayPeche(igloo1, environment,t);
	igloo1.displayFil(positionInitiale, timer, environment);
