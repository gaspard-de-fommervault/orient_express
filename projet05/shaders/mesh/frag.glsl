...
{ 
	...
	GLfloat bronze_ambient [4] = {0.21, 0.71, 0.39, 1.0};
	GLfloat bronze_diffuse [4] = {0.13, 0.43, 0.27, 1.0};
	GLfloat bronze_specular [4] = {0.05, 0.18, 0.17, 1.0};
	GLfloat bronze_shininess [1] = {25.6};
	...
	glMaterialfv (GL_FRONT_AND_BACK, GL_SHININESS, bronze_shininess);
 }
 */